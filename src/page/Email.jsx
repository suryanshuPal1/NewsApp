    ...
    return(
      ...
      <div className="flex bg-white shadow-lg rounded-lg overflow-hidden h-[720px] w-[1200px]">
         ...
         <div className="w-1/2 mt-10 ">
            <h2 className="text-2xl font-bold flex justify-center p-10 text-[#0A0E4B] text-bold">
                Email Verification </h2>
                <p className="text-gray-600  w-[400px] p-2 ml-[100px]">We're sent an verification to <span className="text-[#0A0E4B] font-semibold">arun14@gmail.com</span> to verify your email address and active your account.</p>
         ...
         <div className=" mt-[60px] ">
            ...
            <div className="mt-10">
                <button className="bg-blue-900 text-white w-[450px] h-[50px] ml-[60px]  rounded-md hover:bg-blue-700 transition">Verify My Email</button>
            </div>
            </div>
